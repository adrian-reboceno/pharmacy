    ...
    <div class="col-xxl-9">
        <div class="card">
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('pharmaceuticalforms.update', $pharmaceuticalForm->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="pharmaceuticalform_name" id="name" placeholder="Enter status name" value="{{ $pharmaceuticalForm->name }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="description" id="description" rows="3" placeholder="Enter description">{{$pharmaceuticalForm->description }}</textarea>
                                @error('description')                                           
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
