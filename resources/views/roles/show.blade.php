                                ...
                                <div class="col-md">
                                    <div>
                                        ...
                                        <div class="hstack gap-3 flex-wrap">                                          
                                            <div class="vr"></div>
                                            <div>Create Date : <span class="fw-medium">{{$role->created_at}}</span></div>
                                            <div class="vr"></div>
                                            <div>Due Date : <span class="fw-medium">{{$role->updated_at}}</span></div>
                                            <div class="vr"></div>                                           
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-muted">
                                    <h6 class="mb-3 fw-semibold text-uppercase">Permision</h6>
                                    <div class="col-lg-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-check form-switch form-switch-success">
                                                                <input class="form-check-input" type="checkbox" role="success" value="{{ $permission->name }}" {{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }} id="permission-{{ $permission->id }}" name="permissions[{{$permission->name }}]" disabled>   
                                        ...
                                        <div class="row apps-pro-ov">
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    ...
                                                    <h5 class="fs-15 mb-0">{{$role->created_at}}</h5>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    <p class="mb-2 text-uppercase fw-medium">Due Date :</p>
                                                    <h5 class="fs-15 mb-0">{{$role->updated_at}}</h5>
                                                </div>
                                            </div>                                           
                                        </div>
                                    </div>                                   
