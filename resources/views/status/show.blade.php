                    ...
                    <div class="row mb-3">
                        <div class="col-md">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-md">
                                    <div>
                                        <h4 class="fw-bold">{{$status->status_name}}</h4>
                                        <div class="hstack gap-3 flex-wrap">                                          
                                            <div class="vr"></div>
                                            <div>Create Date : <span class="fw-medium">{{$status->created_at}}</span></div>
                                            <div class="vr"></div>
                                            <div>Due Date : <span class="fw-medium">{{$status->updated_at}}</span></div>
                                            <div class="vr"></div>                                           
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row apps-pro-ov">
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    ...
                                                    <h5 class="fs-15 mb-0">{{$status->created_at}}</h5>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    <p class="mb-2 text-uppercase fw-medium">Due Date :</p>
                                                    <h5 class="fs-15 mb-0">{{$status->updated_at}}</h5>
                                                </div>
                                            </div>                                           
                                        </div>
                                    </div>                                   
