...
<link href="{{ URL::asset('https://cdn.datatables.net/responsive/2.2.9/css/responsive.bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">                       
                        <div class="d-flex gap-2 flex-wrap">    
                            @can('status-create')                        
                                <a href="{{route('batches.create')}}" class="btn btn-primary"><i class="ri-add-line align-bottom me-1"></i> @lang('translation.batch')</a>
                            @endcan
                        </div>
                ...
                <table id="datatables" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                    <thead>
                        <tr>                            
                            ...
                            <th data-ordering="false">Total units box</th>
                            <th data-ordering="false">Active principle</th> 
                            <th data-ordering="false">Quantity {{-- / Unit measure< --}}</th>                                                                                                          
                            <th data-ordering="false">Number manufacturer </th>
                            <th data-ordering="false">Purchase price</th>
                            <th data-ordering="false">Sale price</th>                            
                            <th data-ordering="false">Category</th>
                            <th data-ordering="false">Expiration date</th>    
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{$batch->product->quantity}} / {{$batch->product->UnitMeasure->abbreviation}} </td>                                                        
                            ...
                            <td>
                                <div class="dropdown d-inline-block">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        @can('status-show') 
                                            <li><a href="{{ route('batches.show', $batch->id)}}" class="dropdown-item"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                        @endcan
                                        @can('status-edit') 
                                        <li><a href="{{ route('batches.edit', $batch->id)}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                        @endcan                                        
                                        @can('status-delete') 
                                            <li>                                               
