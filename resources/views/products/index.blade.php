                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">                       
                        <div class="d-flex gap-2 flex-wrap">    
                            @can('status-create')                        
                                <a href="{{route('products.create')}}" class="btn btn-primary"><i class="ri-add-line align-bottom me-1"></i> @lang('translation.product')</a>
                            @endcan
                        </div>
                ...
                <table id="datatables" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                    <thead>
                        <tr>                            
                            ...
                            <th data-ordering="false">Unit measure</th>                                                     
                            <th data-ordering="false">quantity</th>                                          
                            <th data-ordering="false">Stock min</th>
                            <th data-ordering="false">Stock max</th>
                            <th data-ordering="false">Sanitary registration</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$product->sanitary_registration}}</td> 
                            <td>{{$product->category->category_name}} </td> 
                            <td>{{$product->expiration_date ? 'Yes': 'No'}}</td>                                                                                                  
                            <td>
