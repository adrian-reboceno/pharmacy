                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter barcode" name="barcode" id="barcode" value="{{ $product->barcode }}">
                                </div>
                                @error('barcode')
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter name" name="name" id="name" value="{{ $product->name }}">
                                </div>
                                @error('name')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Metformina"  id="activesubstance" name="activesubstance" value="{{ $product->active_principle }}" >
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="10" id="stockmin" name="stockmin" value="{{ $product->stock_min}}">    
                                        </div>
                                        @error('stockmin')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="10" id="stockmax" name="stockmax" value="{{ $product->stock_max }}">  
                                        </div>
                                        @error('stockmax')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-switch form-switch-success">
                                                <input class="form-check-input" type="checkbox" role="success" value="1" {{ $product->expiration_date == 1 ? 'checked' : '' }} id="expirationdate" name="expirationdate">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-switch form-switch-success">
                                                <input class="form-check-input" type="checkbox" role="success" value="1" {{ $product->sale_piece == 1 ? 'checked' : '' }}  id="salebypiece" name="salebypiece">
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="unitmeasure" name="unitmeasure" class="form-select" id="choices-publish-status-input" data-choices data-choices-search-false>                                                
                                                @foreach ( $unitMeasures as $unitMeasure)
                                                    <option value="{{ $unitMeasure->id }}" {{$unitMeasure->id ==  $product->unit_measure_id ? 'selected' : ''}}>{{ $unitMeasure->name }} / {{ $unitMeasure->abbreviation }}</option>
                                                @endforeach                                     
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="10" id="quantity" name="quantity" value="{{ $product->quantity }}">
                                        </div>
                                        @error('quantity')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="10" step="1" id="unitsblister" name="unitsblister" value="{{ $product->units_blister }}">
                                        </div>
                                        @error('unitsblister')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="30" step="1" id="unitsbox" name="unitsbox" value="{{ $product->units_box }}">
                                        </div>
                                        @error('unitsbox')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group has-validation mb-3">
                                                ...
                                                <input type="number" step="0.01" class="form-control" name="utility" id="utility" placeholder="Enter price" aria-label="utility" aria-describedby="product-utility-addon"  value="{{ $product->utility }}">                                              
                                            </div>
                                        </div>
                                        @error('utility')
                                            <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="1000 SSA IV" id="sanitary_registration" name="sanitary_registration" value="{{ $product->sanitary_registration }}">                               
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="laboratory" name="laboratory" class="js-example-basic-single">                                               
                                                @foreach ( $laboratories as $laboratory)
                                                    <option value="{{ $laboratory->id }}" {{$laboratory->id ==  $product->laboratory_id ? 'selected' : ''}}>{{ $laboratory->name }}</option>
                                                @endforeach                                     
                                            </select>
                                        </div>
                                        @error('laboratory')
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select id="denomination" name="denomination" class="js-example-basic-single">                                              
                                                ...
                                                <option value="{{ $denomination->id }}" {{$denomination->id ==  $product->denomination_id ? 'selected' : ''}}>{{ $denomination->name }}</option>
                                                @endforeach 
                                            </select>
                                        </div>
                                        @error('denomination')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="saletype" name="saletype" class="js-example-basic-single">
                                                ...
                                                @foreach ( $saleTypes as $saletype)
                                                    <option value="{{ $saletype->id }}" {{$saletype->id ==  $product->sale_type_id ? 'selected' : ''}} >{{ $saletype->name }}</option>
                                                @endforeach 
                                            </select>
                                        </div>
                                        @error('saletype')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="pharmaceuticalforms" name="pharmaceuticalforms" class="js-example-basic-single">                                                
                                                @foreach ( $pharmaceuticalForms as $pharmaceuticalForm)
                                                    <option value="{{ $pharmaceuticalForm->id }}" {{$pharmaceuticalForm->id ==  $product->pharmaceutical_form_id ? 'selected' : ''}} >{{ $pharmaceuticalForm->name }}</option>
                                                @endforeach 
                                            </select>
                                        </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select id="status" name="status" class="js-example-basic-single">
                                ...
                                <option value="{{ $status->id }}" {{$status->id ==  $product->status_id ? 'selected' : ''}}>{{ $status->status_name }}</option>
                            @endforeach                              
                            </select>
                        </div>
                        @error('status')
                ...
                <div class="card">
                    ...
                    <div class="card-body">                       
                        <select class="js-example-basic-multiple" name="symptoms[]" multiple="multiple">
                            ...
                            <option value="{{ $symptom->id }}" {{ in_array($symptom->id, $productSymptoms) ? 'selected' : '' }}>  {{ $symptom->symptom_name }}</option>
                        @endforeach
                        </select>              
                        @error('symptoms')
                            <div class="text-danger">{{ $message }}</div>
