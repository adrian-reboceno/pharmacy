                    ...
                    <div class="row mb-3">
                        <div class="col-md">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-md">
                                    <div>
                                        <h4 class="fw-bold">{{$denomination->name}}</h4>
                                        <div class="hstack gap-3 flex-wrap">                                          
                                            <div class="vr"></div>
                                            <div>Create Date : <span class="fw-medium">{{$denomination->created_at}}</span></div>
                                            <div class="vr"></div>
                                            <div>Due Date : <span class="fw-medium">{{$denomination->updated_at}}</span></div>
                                            <div class="vr"></div>                                           
                                        </div>
                                    </div>
                                </div>
