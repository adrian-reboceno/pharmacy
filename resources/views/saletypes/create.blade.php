    ...
    <div class="col-xxl-9">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Create sale type</h4>                
            </div><!-- end card header -->
            <div class="card-body p-4">
                <form method="POST" action="{{ route('saletypes.store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="saletype_name" class="form-label">Sale type name</label>
                                <input type="text" class="form-control" name="saletype_name" id="saletype_name" placeholder="Enter status name" value="{{ old('saletype_name') }}">
                                @error('saletype_name')                                           
