                    ...
                    <div class="table-responsive">
                        <table class="table mb-0 table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    <th><span class="fw-medium">State</span></th>
                                    <td>{{$supplier->state->name}}</td>
                                </tr>  
                                <tr>
                                    <th><span class="fw-medium">Contact name</span></th>
                                    <td>{{$supplier->contact_person}}</td>
                                </tr>  
                                <tr>
                                    <th><span class="fw-medium">Contact phone</span></th>
                                    <td>{{$supplier->contact_phone}}</td>
                                </tr>                
                                <tr>
                                    <th><span class="fw-medium">Contact email</span></th>
