                    ...
                    <div class="row mb-3">
                        <div class="col-md">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-md">
                                    <div>
                                        <h4 class="fw-bold">{{$pharmaceuticalForm->name}}</h4>
                                        <div class="hstack gap-3 flex-wrap">                                          
                                            <div class="vr"></div>
                                            <div>Create Date : <span class="fw-medium">{{$pharmaceuticalForm->created_at}}</span></div>
                                            <div class="vr"></div>
                                            <div>Due Date : <span class="fw-medium">{{$pharmaceuticalForm->updated_at}}</span></div>
                                            <div class="vr"></div>                                           
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-muted">
                                    ...
                                    <p>{{$pharmaceuticalForm->description}}</p>                                  
                                    <div class="pt-3 border-top border-top-dashed mt-4">
                                        <div class="row apps-pro-ov">
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    <p class="mb-2 text-uppercase fw-medium">Create Date :</p>
                                                    <h5 class="fs-15 mb-0">{{$pharmaceuticalForm->created_at}}</h5>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    <p class="mb-2 text-uppercase fw-medium">Due Date :</p>
                                                    <h5 class="fs-15 mb-0">{{$pharmaceuticalForm->updated_at}}</h5>
                                                </div>
                                            </div>                                           
                                        </div>
                                    </div>                                   
