    ...
    <div class="col-xxl-9">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Create symptom</h4>                
            </div><!-- end card header -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="symptom_name" id="symptom_name" placeholder="Enter status name" value="{{ old('symptom_name') }}">
                                @error('symptom_name')                                           
