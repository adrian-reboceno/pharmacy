...
const folder = {
    ...
    src_assets: "public/assets/", // source assets files
...
export default defineConfig({
    ...
    plugins: [
        laravel(
            {
                input: [
                    'public/build/scss/bootstrap.scss',
                    'public/build/scss/icons.scss',
                    'public/build/scss/app.scss',
                    'public/build/scss/custom.scss',
