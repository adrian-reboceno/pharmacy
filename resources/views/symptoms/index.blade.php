                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">                       
                        <div class="d-flex gap-2 flex-wrap">    
                            @can('symptom-create')                        
                                <a href="{{route('symptoms.create')}}" class="btn btn-primary"><i class="ri-add-line align-bottom me-1"></i> @lang('translation.symptom')</a>
                            @endcan
                        </div>
                            ...
                            <td>
                                <div class="dropdown d-inline-block">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        @can('symptom-show') 
                                            <li><a href="{{ route('symptoms.show', $symptom->id)}}" class="dropdown-item"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                        @endcan
                                        @can('symptom-edit') 
                                        <li><a href="{{ route('symptoms.edit', $symptom->id)}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                        @endcan
                                        @can('symptom-delete') 
                                            <li>                                               
